...
> **Note:** Lotte-integrated APIs for **Derivatives only**. For Equity orders, see `@Knowledge/TradeX/Planning/regular-order-api-mapping.md`. **Tham chiếu Lotte:** [Lotte_DR.md](../../../Documentation/Lotte_DR_API_Specs.md) (27/02/2026) — §2.3.9–2.3.12, 2.3.3, 2.3.4.
...
**Lotte (DRORD-010):** [Lotte_DR.md §2.3.3](../../../Documentation/Lotte_DR_API_Specs.md) — URL: `[Root URL APIKEY]/tuxsvc/der/order/dr-order-history`; Method: POST. Request body: `hts_user_id`, `acnt`, `date`, `next_data`. **Chỉ tra cứu trong ngày** (một `date` duy nhất).
...
**Lotte (DRORD-033):** [Lotte_DR.md §2.3.13](../../../Documentation/Lotte_DR_API_Specs.md) — Tra cứu lịch sử đặt lệnh thường (fromdate – todate). Method: POST. Request body: `hts_user_id`, `acnt`, `date_fr`, `date_to`, `next_data`.
