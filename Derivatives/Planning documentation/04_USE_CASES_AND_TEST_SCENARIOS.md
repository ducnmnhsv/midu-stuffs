...
| 6 | Hệ thống | Đánh dấu mã phái sinh với `market: "derivatives"` | Phân biệt rõ ràng |
...
| 5 | Hệ thống | Trả về danh sách với `market: "derivatives"` | Response data |
...
| 3 | Hệ thống | Trả về thông tin đầy đủ | Response data |
...
| 7 | Verify mã phái sinh | `HGET realtime_mapSymbolInfo VN30F2501` | Có `m: "derivatives"` |
| 8 | Verify file S3 | Download symbol_static.json | Có mã phái sinh với format chuẩn |

**Expected format trong symbol_static.json:**
```json
{
    "s": "VN30F2501",
    "m": "derivatives",
...
- ✅ ~2000 mã cơ sở
- ✅ 4-8 mã phái sinh
- ✅ Tất cả mã phái sinh có `market: "derivatives"`
...
| 5 | Verify m field | - | `m: "derivatives"` |
...
- [ ] Mã phái sinh có `market: "derivatives"`
