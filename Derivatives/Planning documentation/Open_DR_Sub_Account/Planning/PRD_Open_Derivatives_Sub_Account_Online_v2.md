...
**Version:** 2.1 (revalidate FPT spec theo PDF v3.0 10/2023 + chuẩn hoá naming convention TradeX — kế thừa [v1.0](./PRD_Open_Derivatives_Sub_Account_Online.md))
...
| Accept-Language | `vi` (default) / `en` / `ko` — map sang Lotte `lang_code` `V/E/K` |
...
**Document Status:** 🟢 Ready for Engineering Review (v2.1 — FPT PDF revalidation + TradeX naming)
