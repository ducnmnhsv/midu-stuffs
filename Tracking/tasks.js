...
const TASKS = [
  ...
  // ==========================================================================
  {
    ...
    status: "done", priority: "P1", deadline: null,
    owner: "BE team", jira: null,
    doc: "eKYC/Scope_1/Tech_Spec.md",
    blocks: ["EKYC-02-FE", "EKYC-03-FE", "EKYC-01-FE"], blockedBy: [],
    note: "Complete. Đã gộp hoàn toàn vào luồng Journey Log (EKYC-07-BE) từ 2026-07-20 — không còn bảng/API riêng, xem Tech_Spec.md (thay BE_Issue.md cũ, gộp 2026-07-20).",
  },
  {
    ...
    doc: "eKYC/Scope_1/Tech_Spec.md",
    blocks: [], blockedBy: [],
    note: "Đã gộp hoàn toàn vào EKYC-07-SPEC từ 2026-07-20 (PRD v4.0 mục 4) — không còn bảng/API riêng, VNPT data là payload của step EKYC_FACE_SCAN trong Tech_Spec.md (Phần BE), chỉ ghi khi thành công.",
  },
  {
    ...
    note: "Redesign 2026-07-15 — screen-based, full payload, gộp sub-feature 05. Thay thế Journey_API_Reference.md. Bổ sung 2026-07-20 (b): thêm step PERSONAL_DATA_PROCESSING_CONSENT (12 step total). Bổ sung 2026-07-20 (c): đã chốt câu hỏi purge policy — bằng chứng consent giữ vĩnh viễn, loại trừ khỏi purge job (PRD mục 4.4). Gộp EKYC-01-SPEC vào đây từ 2026-07-20 — 1 luồng duy nhất, xem Tech_Spec.md (Phần BE, thay BE_Spec.md cũ, gộp thêm với BE_Issue.md/FE_Issue.md thành 1 file cuối 2026-07-20).",
  },
  {
    ...
    note: "Issue tạo 2026-07-16, viết lại theo style BA/PO 2026-07-20 — gộp chung với EKYC-01-BE (không còn task riêng cho biometric attempt log). Cần FE Lead confirm effort sửa ~10 màn hình App trước khi kickoff (đã tính +1 màn hình PDPD consent, 2026-07-20). Xem Tech_Spec.md Phần BE (thay BE_Issue.md cũ).",
  },
  {
    ...
    note: "Mới tạo 2026-07-20 — đóng gap '01 chưa có FE issue' ghi nhận từ 2026-07-20(a). Đã gộp hoàn toàn vào EKYC-07-FE từ 2026-07-20 (PRD v4.0 mục 4) — API /ekycs/attempt-log không còn tồn tại; bước quét khuôn mặt & CCCD giờ là step EKYC_FACE_SCAN trong journey-log, chỉ gọi khi VNPT thành công. Xem Tech_Spec.md Phần FE.",
  },
  {
    ...
    note: "Mới tạo 2026-07-16. Chờ BE endpoint /ekycs/journey-log live + FE Lead confirm effort trước khi kickoff. Bổ sung 2026-07-20: +1 màn hình mới (checkbox PDPD consent, chặn nút Tiếp theo) — không còn thuần instrumentation. Gộp EKYC-01-FE vào đây từ 2026-07-20 (1 luồng duy nhất) — bước quét khuôn mặt & CCCD (step 5) giờ chỉ gọi log khi VNPT thành công, cùng rule retry khi mất mạng áp dụng chung. Xem Tech_Spec.md Phần FE (thay FE_Issue.md cũ, gộp thêm với BE_Spec.md/BE_Issue.md thành 1 file cuối 2026-07-20).",
  },
  {
