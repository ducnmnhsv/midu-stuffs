...
/**
 * @swagger
 * /derivatives/order/modify/all:
 *   put:
 *     tags:
 *       - Derivatives Order
 *     summary: Modify All Derivatives Order
 *     security:
 *       - jwt: []
 *     requestBody:
 *       content:
 *         application/json:
 *           schema:
 *             $ref: '#/components/schemas/DerivativesOrderModifyAllRequest'
 *       description: Order Modify object
 *       required: true
 *     responses:
 *       200:
 *         description: Modify All Order Successfully
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/MessageResponse'
