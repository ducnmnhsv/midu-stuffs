 ...
 *     EquityTradingSummaryResponse:
 *       type: object
 *       properties:
 *         stockCode:
 *           type: string
 *           description: the stock code of the trading record
 *         sellBuyType:
 *           type: string
 *           description: the sell/buy type of the trading record
 *         orderQuantity:
 *           type: integer
 *           description: the order quantity of the trading record
 *         orderPrice:
 *           type: string
 *           description: the order price of the trading record
 *         averagePrice:
 *           type: number
 *           format: double
 *           description: the average price of the trading record
 *         matchQuantity:
 *           type: string
 *           description: the match quantity of the trading record
 *         unmatchQuantity:
 *           type: string
 *           description: the unmatch quantity of the trading record
 *         amount:
 *           type: number
 *           format: double
 *           description: the amount of the trading record
 *         matchDate:
 *           type: string
 *           description: the match date of the trading record, format is 'yyyyMMdd'
 *         fee:
 *           type: number
 *           format: double
 *           description: the fee of the trading record
 *         tax:
 *           type: number
 *           format: double
 *           description: the tax of the trading record
 *         adjustedAmount:
 *           type: number
 *           format: double
 *           description: the net amount of the trading record
 *     EquityAssetInfoResponse:
 *       type: object
 *       properties:
 *         netAsset:
 *           type: number
 *           format: double
 *           description: the net asset amount of the account
 *         totalAsset:
 *           type: number
 *           format: double
 *           description: the total asset amount of the account
 *         totalCash:
 *           type: number
 *           format: double
 *           description: the total cash amount of the account
 *         availableCash:
 *           type: number
 *           format: double
 *           description: the available cash amount of the account
 *         unavailableCash:
 *           type: number
 *           format: double
 *           description: the unavailable cash amount of the account
 *         reuseAmount:
 *           type: number
 *           format: double
 *           description: the  waiting selling amount without PIA of account
 *         dividend:
 *           type: number
 *           format: double
 *           description: the dividend amount of the account
 *         stockEvaluationAmount:
 *           type: number
 *           format: double
 *           description: Evaluation amount of own stocks
 ...
 *           type: number
 *           format: double
 *           description: available stock amount of the account
 *         unavailableStockAmount:
 *           type: number
 *           format: double
 *           description: unavailable stock amount of the account
 *         buyingStockWaitingAmount:
 *           type: number
 *           format: double
 *           description: the buying amount for waiting stock of the account
 *         rights:
 *           type: number
 *           format: double
 *           description: the rights amount of all stocks of the account
 *         pendingStockAmount:
 *           type: number
 *           format: double
 *           description: the amount of stocks that's waiting for trading
 *         totalLoanAmount:
 *           type: number
 *           format: double
 ...
 *           format: double
 *           description: the margin loan amount
 *         nonSettledBuyingAmount:
 *           type: number
 *           format: double
 *           description: the buying amount that hasn't been settled yet
 *         unmatchBuyingAmount:
 *           type: number
 *           format: double
 *           description: the buying amount that hasn't been matched yet
 *         interest:
 *           type: number
 *           format: double
 *           description: the estimate interest
 *         depositoryFee:
 *           type: number
 *           format: double
 *           description: the depository fee
 *         minBuyingPower:
 *           type: number
 *           format: double
 *           description: the minimum buying power
 *         withdrawableAmount:
 *           type: number
 *           format: double
 *           description: the withdrawable amount to remain the margin ratio
 *         cmr:
 *           type: number
 *           format: double
 *           description: the CMR of the account
 *         cashAmountForMMR:
 *           type: number
 *           format: double
 *           description: the required cash amount enough for MMR
 *         stockAmountForMMR:
 *           type: number
 *           format: double
 *           description: the required stock amount enough for MMR
 *         virtualDeposit:
 *           type: number
 *           format: double
 *           description: the virtual deposit amount of the account
 *         usedVirtualDeposit:
 *           type: number
 *           format: double
 *           description: the used virtual deposit amount of the account
 *         totalLackingSettledAmount:
 *           type: number
 *           format: double
 *           description: the total lacking settlement amount
 *         lackingMarginAmount:
 *           type: number
 *           format: double
 *           description: the lacking margin amount
 *         lackingVirtualDepositAmount:
 *           type: number
 *           format: double
 *           description: the lacking virtual deposit amount
 *         lackingLoanAmountForT1:
 *           type: number
 *           format: double
 *           description: the lacking loan amount for T-1
 *     EquityAccountLoanHistoryResponse:
 *       type: object
 *       properties:
 *         loanDate:
 *           type: string
 *           description: the loan date of the record, format is 'yyyyMMdd'
 *         expireDate:
 *           type: string
 *           description: the expire date of the loan record, format is 'yyyyMMdd'
 *         matchDate:
 *           type: string
 *           description: the match date of the loan record, format is 'yyyyMMdd'
 *         stockCode:
 *           type: string
 *           description: the stock code of the loan record
 *         loanType:
 *           type: string
 *           description: the loan type of the loan record
 *         loanBankCode:
 *           type: string
 *           description: the loan bank code of the loan record
 *         quantity:
 *           type: integer
 *           description: the loan quantity of the record
 *         amount:
 *           type: number
 *           format: double
 *           description: the loan amount of the record
 *         interest:
 *           type: number
 *           format: double
 *           description: the interest of the loan record
 *         repayAmount:
 *           type: number
 *           format: double
 *           description: the repay amount of the loan record
 *         remainAmount:
 *           type: number
 *           format: double
 *           description: the remaining amount of the loan record
 *         status:
 *           type: string
 *           description: the status of the loan record
