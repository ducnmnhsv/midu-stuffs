...
@Data
public class OcoOrderTodayResponse {
    private Long id;
    ...
    public static OcoOrderTodayResponse fromOcoOrder(ObjectMapper objectMapper, OcoOrder ocoOrder) {
        OcoOrderTodayResponse response = new OcoOrderTodayResponse();
        ...
        response.setStatus(ocoOrder.getStatus().name());
