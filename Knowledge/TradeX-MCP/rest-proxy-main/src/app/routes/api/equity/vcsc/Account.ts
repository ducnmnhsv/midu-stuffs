...
/**
 * @swagger
 * /equity/account/tradingSummary:
 *   get:
 *     tags:
 *       - Equity Account
 *     summary: Query Trading Summary of Account
 *     security:
 *       - jwt: []
 *     parameters:
 *       - in: query
 ...
 *       - in: query
 *         name: fromDate
 *         description: query trading summary that place after or on this date, format is **yyyyMMdd**, default is **19700101**
 *         schema:
 *           type: string
 *       - in: query
 *         name: toDate
 *         description: query trading summary that place before or on this date, format is **yyyyMMdd**, default is **today**
 *         schema:
 *           type: string
 *       - in: query
 *         name: stockCode
 ...
 *           type: string
 *       - in: query
 *         name: lastSellBuyType
 *         description: the last sell buy type from previous query used to load more data
 *         schema:
 *           type: string
 *           enum:
 *             - SELL
 ...
 *     responses:
 *       200:
 *         description: Account Trading Summary Information
 *         content:
 *           application/json:
 *             schema:
 *               type: array
 *               items:
 *                 $ref: '#/components/schemas/EquityTradingSummaryResponse'
 *       401:
 *         description: Your access token is invalid or expired
 */
...
/**
 * @swagger
 * /equity/account/assetInfo:
 *   get:
 *     tags:
 *       - Equity Account
 *     summary: Query Asset Info of Account
 *     security:
 *       - jwt: []
 *     parameters:
 *       - in: query
 ...
 *       - in: query
 *         name: bankAccount
 *         description: bank account number to query cash balance, no need to set if bankCode is **9999**
 *         schema:
 *           type: string
 *     responses:
 *       200:
 *         description: Account Asset Info Information
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/EquityAssetInfoResponse'
 *       401:
 *         description: Your access token is invalid or expired
 */
...
/**
 * @swagger
 * /equity/account/loanHistory:
 *   get:
 *     tags:
 *       - Equity Account
 *     summary: Query Loan History of Account
 *     security:
 *       - jwt: []
 *     parameters:
 *       - in: query
 ...
 *       - in: query
 *         name: lastLoanType
 *         description: the last loan type from previous query used to load more data
 *         schema:
 *           type: string
 *       - in: query
 *         name: lastLoanDate
 ...
 *               type: array
 *               items:
 *                 $ref: '#/components/schemas/EquityAccountLoanHistoryResponse'
 *       401:
 *         description: Your access token is invalid or expired
 */
