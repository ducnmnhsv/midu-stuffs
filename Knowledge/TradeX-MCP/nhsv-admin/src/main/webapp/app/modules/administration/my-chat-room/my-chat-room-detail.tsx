...
import { getEntity, reset } from './my-chat-room.reducer';
import { getSession } from 'app/shared/reducers/authentication';

export const MyChatRoomLink = () => {
  ...
  const chatRoomEntity = useAppSelector(state => state.createdChatRoom.entity);
  return (
    <div className="popup">
