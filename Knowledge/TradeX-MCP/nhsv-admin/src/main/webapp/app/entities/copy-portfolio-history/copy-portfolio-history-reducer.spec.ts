...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './copy-portfolio-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COPYPORTFOLIOHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_COPYPORTFOLIOHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COPYPORTFOLIOHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COPYPORTFOLIOHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COPYPORTFOLIOHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COPYPORTFOLIOHISTORY actions', async () => {
      const expectedActions = [
        {
