...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './copy-portfolio-details.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COPYPORTFOLIODETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COPYPORTFOLIODETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COPYPORTFOLIODETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COPYPORTFOLIODETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COPYPORTFOLIODETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COPYPORTFOLIODETAILS actions', async () => {
      const expectedActions = [
        {
