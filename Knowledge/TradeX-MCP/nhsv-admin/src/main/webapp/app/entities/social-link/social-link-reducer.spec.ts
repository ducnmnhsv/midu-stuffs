...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOCIALLINK_LIST actions', async () => {
    ...
    it('dispatches FETCH_SOCIALLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOCIALLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOCIALLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOCIALLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOCIALLINK actions', async () => {
      const expectedActions = [
        {
