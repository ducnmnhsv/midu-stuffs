...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './copy-trading-register.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COPYTRADINGREGISTER_LIST actions', async () => {
    ...
    it('dispatches FETCH_COPYTRADINGREGISTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COPYTRADINGREGISTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COPYTRADINGREGISTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COPYTRADINGREGISTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COPYTRADINGREGISTER actions', async () => {
      const expectedActions = [
        {
