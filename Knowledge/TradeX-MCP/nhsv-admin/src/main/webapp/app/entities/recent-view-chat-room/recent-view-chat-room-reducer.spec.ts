...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './recent-view-chat-room.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECENTVIEWCHATROOM_LIST actions', async () => {
    ...
    it('dispatches FETCH_RECENTVIEWCHATROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RECENTVIEWCHATROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RECENTVIEWCHATROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RECENTVIEWCHATROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RECENTVIEWCHATROOM actions', async () => {
      const expectedActions = [
        {
