...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './copy-trading-order.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COPYTRADINGORDER_LIST actions', async () => {
    ...
    it('dispatches FETCH_COPYTRADINGORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COPYTRADINGORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COPYTRADINGORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COPYTRADINGORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COPYTRADINGORDER actions', async () => {
      const expectedActions = [
        {
