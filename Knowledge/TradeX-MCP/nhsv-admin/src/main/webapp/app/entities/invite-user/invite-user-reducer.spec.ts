...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVITEUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_INVITEUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INVITEUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INVITEUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INVITEUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INVITEUSER actions', async () => {
      const expectedActions = [
        {
