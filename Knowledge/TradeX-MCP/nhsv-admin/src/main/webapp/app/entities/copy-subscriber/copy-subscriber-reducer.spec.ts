...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COPYSUBSCRIBER_LIST actions', async () => {
    ...
    it('dispatches FETCH_COPYSUBSCRIBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COPYSUBSCRIBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COPYSUBSCRIBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COPYSUBSCRIBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COPYSUBSCRIBER actions', async () => {
      const expectedActions = [
        {
