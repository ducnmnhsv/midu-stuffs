...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COPYPORTFOLIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_COPYPORTFOLIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COPYPORTFOLIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COPYPORTFOLIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COPYPORTFOLIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COPYPORTFOLIO actions', async () => {
      const expectedActions = [
        {
