...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './copy-market-leader-details.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COPYMARKETLEADERDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COPYMARKETLEADERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COPYMARKETLEADERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COPYMARKETLEADERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COPYMARKETLEADERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COPYMARKETLEADERDETAILS actions', async () => {
      const expectedActions = [
        {
