...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './chat-room.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHATROOM_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHATROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHATROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHATROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHATROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHATROOM actions', async () => {
      const expectedActions = [
        {
