...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './copy-subscriber-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COPYSUBSCRIBERHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_COPYSUBSCRIBERHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COPYSUBSCRIBERHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COPYSUBSCRIBERHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COPYSUBSCRIBERHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COPYSUBSCRIBERHISTORY actions', async () => {
      const expectedActions = [
        {
