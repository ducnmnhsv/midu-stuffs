...
import { getEntity, deleteEntity } from './social-link.reducer';

export const SocialLinkDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(socialLinkEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="nhsvAdminApp.socialLink.delete.question">Are you sure you want to delete Social Link {socialLinkEntity.id}?</ModalBody>
      <ModalFooter>
...
export default SocialLinkDeleteDialog;
