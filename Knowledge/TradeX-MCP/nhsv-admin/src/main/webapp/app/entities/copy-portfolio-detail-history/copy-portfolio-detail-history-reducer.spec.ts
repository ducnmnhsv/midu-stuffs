...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './copy-portfolio-detail-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COPYPORTFOLIODETAILHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_COPYPORTFOLIODETAILHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COPYPORTFOLIODETAILHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COPYPORTFOLIODETAILHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COPYPORTFOLIODETAILHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COPYPORTFOLIODETAILHISTORY actions', async () => {
      const expectedActions = [
        {
