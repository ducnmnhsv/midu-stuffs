...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './created-chat-room.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CREATEDCHATROOM_LIST actions', async () => {
    ...
    it('dispatches FETCH_CREATEDCHATROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CREATEDCHATROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CREATEDCHATROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CREATEDCHATROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CREATEDCHATROOM actions', async () => {
      const expectedActions = [
        {
