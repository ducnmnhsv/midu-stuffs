...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './market-history-job-result.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MARKETHISTORYJOBRESULT_LIST actions', async () => {
    ...
    it('dispatches FETCH_MARKETHISTORYJOBRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MARKETHISTORYJOBRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MARKETHISTORYJOBRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MARKETHISTORYJOBRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MARKETHISTORYJOBRESULT actions', async () => {
      const expectedActions = [
        {
