...
@Primary
@Data
public class InviteUserPrimaryCriteria implements Serializable, Criteria {
    ...
    public InviteUserPrimaryCriteria() {}

    public InviteUserPrimaryCriteria(InviteUserPrimaryCriteria other) {
    ...
    @Override
    public InviteUserPrimaryCriteria copy() {
        return new InviteUserPrimaryCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InviteUserPrimaryCriteria that = (InviteUserPrimaryCriteria) o;
        return (
    ...
    public String toString() {
        return "InviteUserPrimaryCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
