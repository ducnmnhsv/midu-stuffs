...
/**
 * Criteria class for the {@link com.difisoft.nhsv.admin.domain.CreatedChatRoom} entity. This class is used
 * in {@link com.difisoft.nhsv.admin.web.rest.CreatedChatRoomResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /created-chat-rooms?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CreatedChatRoomCriteria implements Serializable, Criteria {
    ...
    private LongFilter totalView;

    private Boolean distinct;

    public CreatedChatRoomCriteria() {}

    public CreatedChatRoomCriteria(CreatedChatRoomCriteria other) {
        ...
        this.totalView = other.totalView == null ? null : other.totalView.copy();
        this.distinct = other.distinct;
    }

    @Override
    public CreatedChatRoomCriteria copy() {
        return new CreatedChatRoomCriteria(this);
    }
    ...
    public LongFilter getTotalView() {
        return totalView;
    }

    public LongFilter totalView() {
        if (totalView == null) {
            totalView = new LongFilter();
        }
        return totalView;
    }

    public void setTotalView(LongFilter totalView) {
    ...
    public boolean equals(Object o) {
        ...
        final CreatedChatRoomCriteria that = (CreatedChatRoomCriteria) o;
        return (
    ...
    public String toString() {
        return "CreatedChatRoomCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            ...
            (totalView != null ? "totalView=" + totalView + ", " : "") +
