...
@Primary
@Data
public class ChatRoomPrimaryCriteria implements Serializable, Criteria {
    ...
    public ChatRoomPrimaryCriteria() {}

    public ChatRoomPrimaryCriteria(ChatRoomPrimaryCriteria other) {
    ...
    @Override
    public ChatRoomPrimaryCriteria copy() {
        return new ChatRoomPrimaryCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ChatRoomPrimaryCriteria that = (ChatRoomPrimaryCriteria) o;
        return (
