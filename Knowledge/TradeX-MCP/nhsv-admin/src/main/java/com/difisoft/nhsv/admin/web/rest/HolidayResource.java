...
import com.difisoft.nhsv.admin.service.HolidayService;
...
/**
 * REST controller for managing {@link com.difisoft.nhsv.admin.domain.Holiday}.
 */
@RestController
@RequestMapping("/api")
public class HolidayResource {
     ...
     */
    @GetMapping("/holidays")
    public ResponseEntity<List<HolidayDTO>> getAllHolidays(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
