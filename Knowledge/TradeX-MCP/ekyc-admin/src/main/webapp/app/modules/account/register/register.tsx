      ...
      <Row className="justify-content-center">
        <Col md="8">
          <AvForm id="register-form" onValidSubmit={handleValidSubmit}>
            <AvField
              name="username"
              label={translate('global.form.usernameLabel')}
              placeholder={translate('global.form.usernamePlaceholder')}
              validate={{
            ...
            <AvField
              name="email"
              label={translate('global.form.emailLabel')}
              placeholder={translate('global.form.emailPlaceholder')}
              type="email"
              validate={{
