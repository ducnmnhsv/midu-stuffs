...
@Data
public class MarketStockInfoListResponse {
    private String code;
    private double open;
    private double high;
    private double low;
...
//    private String companyNameEn;
    ...
    private List<MarketStockInfoResponse.PriceItem> bidOfferList = new ArrayList<>();
    ...
    public void setNormalValue(double normalValue) {
        this.normalValue = Precision.round(normalValue, 2);
    }
