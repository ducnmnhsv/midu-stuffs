...
class LinkAccountHistory extends DefaultBaseModel<LinkAccountHistory> {
    ...
    public deletedAt: FieldModel<Date> = this.field("deleted_at", this.getRow);

    constructor(row: any) {
        super(row);
    }
    
    public clone(): LinkAccountHistory  {
        return new LinkAccountHistory (this.getRow());
    }
    
    public getTableName(): string {
        return "t_link_account_history";
    }
}

export default LinkAccountHistory;